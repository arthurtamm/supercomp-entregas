...
int main(int argc, char* argv[]) {
    ...
    // vector<int> nodes = sortAndRandomizeNodes(graph);

    vector<int> nodes = randomizeNodes(graph);
    vector<int> maxClique = findMaxCliqueParallel(graph, nodes);
