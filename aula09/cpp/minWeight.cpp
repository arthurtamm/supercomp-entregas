...
// 
tuple<int, int, vector<int>> knapsack_min_weight_method(vector<item> items, int capacity) {
...
int main() {
    ...
    auto result = knapsack_min_weight_method(items, capacity);
    auto end = high_resolution_clock::now();
    duration<double> duration = end - start;

    // Printar os resultados do Min Weight Method
    cout << "Min Weight Method:" << endl;
